...
const riskSvg=`  <img src="https://api-v1.riskblacklist.com/icons/7.svg" alt="" width="42" heigth="42">`;
...
function showModalSingIn(closeSpinner){
  if(document.querySelector('.risk_container')){
      ...
      <div class="risk_content">  
          ...
          <div class="risk_logo"><img src="https://api-v1.riskblacklist.com/images/risk-logo.png" alt="" /></div>
      ...
      <div id="risk_signup" style="display: none;">        
                  ...
                  <a href="https://riskblacklist.com/%D8%A7%D9%84%D8%A3%D8%AD%D9%83%D8%A7%D9%85-%D9%88%D8%A7%D9%84%D8%B4%D8%B1%D9%88%D8%B7-%D9%84%D8%A7%D8%B3%D8%AA%D8%AE%D8%AF%D8%A7%D9%85-%D8%A7%D9%84%D8%A7%D8%B6%D8%A7%D9%81%D8%A9-%D9%81%D9%8A-%D8%A7/" style="color: #4bdb2f; font-weight: bold"  target="_blank"> Terms conditions </a> 
                   AND
                   <a href="https://riskblacklist.com/%d8%b3%d9%8a%d8%a7%d8%b3%d8%a9-%d8%a7%d9%84%d8%ae%d8%b5%d9%88%d8%b5%d9%8a%d8%a9/?fbclid=IwAR2XpWIDGVhCtx0WEXI-T8oFzLJSnOx61AluYJY4BqUxp-blAzxP4yl1ZxU" style="color: #4bdb2f; font-weight: bold"  target="_blank">Privacy Policy</a> 
      ...
      </div></div><div class="master_codes"> <img src="https://api-v1.riskblacklist.com/images/mastercodes-logo.png" alt=""><a href='https://mastercodes.dz/' target="_blank"> By MasterCodes</a></div></div>
      `;   
...
for (let i = 0; i < phoneNumbers.length; i++) {
  if (phoneNumbers[i].length ==9) {phoneNumbers[i]= '0' +phoneNumbers[i];}
  ...
  if(successTest==data.length || retry_after!=0 ){
      ...
      buttonMore.addEventListener("click", function () {
         ...
         <span class="short_text">Phone</span> <span class="long_text">Phone Number</span>${phoneSvg} </th>  ${data[0] && data[0].success ? `<td>${data[0].phone}</td>` : ''} ${data[1] && data[1].success ? `<td>${data[1].phone}</td>` : ''} </tr>
         ...
         <img src="https://api-v1.riskblacklist.com/images/mastercodes-logo.png" alt=""><a href='https://mastercodes.dz/' target="_blank">  By MasterCodes</a>
         </div>
